...
3. **[Start using aMule](./interfaces/gui/index.md)** — search for files, manage downloads, and share content.
...
| [aMule Files](./configuration/files/index.md) | Configuration, data, and log files that aMule reads and writes |
